                                            ...
                                            <div class="card border-0 shadow-5-strong bg-dark text-white" style="border-radius: 1rem;">
                                                <div class="card-body p-5 m-4">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-8">
                                                            <h3 class="fw-bold">Número de intentos</h3>
                                                            <p class="small text-muted mb-0">Cantidad de veces que se ha realizado el formulario</p>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4">     
                                                            ...
                                                            include("funciones/abrir_conexion.php");
                                                                ?>
                                                                <h1 class="intentos px-5 mb-2"><?php echo $intentos; ?></h1>
                                                                <?php 
                                                            include("funciones/cerrar_conexion.php");
                                                ...
                                                <div class="card-body p-2">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <a href="respuestas.php">
                                                            <button class="btn btn-outline-light btn-lg" type="submit" name="ultimosResultados">Ver últimos resultados</button>
                                                        </a> 
                                                        </div>
                                                    </div>
                                                </div>
