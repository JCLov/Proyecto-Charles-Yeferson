                            ...
                            <div class="container py-5 text-center">
                                <div class="row">
                                    <div class="col-lg-6 mb-5">
                                        <h1 class="display-4 font-weight-bold mb-5">Acerca de nosotros</h1>
                                        <i class="mb-5" style="line-height: 200%; font-size: large">Somos una iniciativa para ayudar a jóvenes a orientar su futuro. Nos centramos en aportar herramientas y conocimientos adaptados a las necesidades de cada individuo. Mediante nuestro test, te ayudaremos a enfocar tus emprendimientos tomando en cuenta tus fortalezas, capacidades y conocimientos</i>
                                    </div>
                                    <div class="col-lg-6">
                                        <img src="img/info.jpg" class="w-75">
                                    </div>
